...
def main():
    ...
    print(f"Exhibit A: Total Jobs Produced by Party\n"
          ...
          "into accounts, such as recessions. Even though Bill Clinton experienced job count of any president,\n"
          "he inherited the \'dotcom\' boom and thriving economy. George Bush, on the other hand,  experienced the \n"
