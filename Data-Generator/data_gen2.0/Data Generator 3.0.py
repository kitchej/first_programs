"""
DATA GENERATOR 3.0
WRITTEN BY JOSHUA KITCHEN - VERSION 1.0: Summer 2019; THIS VERSION: Feb 2020
------------------------------------------------------------------------------
- Added a graphical interface
- Added added a random card draws function
- Added single draws/rolls/tosses for card draws, dice rolls, and coin
tosses
- Random People, Students, and Employees now have labels above their attributes
-------------------------------------------------------------------------------
CATEGORIES AVAILABLE(version 3.0):
- DATES
...
def generate_custom_data():
    ...
    funcs = {
        ...
        "String/Char": create_user_database_frame,
...
def create_user_database_frame(build_frame, is_called_in_custom=False):
    ...
    def get_data_file():
        root.filename = filedialog.askopenfilename(filetypes=[('Text Documents', '*.txt')])
